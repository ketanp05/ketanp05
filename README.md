...
Ketan is also actively looking for opportunities in Software/Backend Engineer (Python/C++/Flask/FastAPI/Django/MySQL/PostgreSQL), Data Engineer (PySpark/Databricks/SQL/AWS), Analyst (Manufacturing/MES) roles, and IT/Business Analytics.
## 🌐 Socials:
